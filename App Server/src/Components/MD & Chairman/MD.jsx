...
import './MD.css'
import img from './Assets/doctor1.jpg' // Create and style this CSS file accordingly
  ...
  return (
    ...
    <div className="md-chairman-content">
      ...
      <div className='md-chairman-text2'>
        ...
        <p>As we move forward, I am committed to expanding the horizons of Erode Cancer Centre, fostering partnerships, and nurturing talent that will contribute to the future of oncology. Together, with the unwavering trust of our patients and the relentless dedication of our team, we aim to redefine cancer care in India and beyond.</p>
