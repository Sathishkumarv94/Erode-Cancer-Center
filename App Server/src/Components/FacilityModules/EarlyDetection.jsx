        ...
        <div className="service-content">
          ...
          <div className="image-text-section" data-aos="fade-up">
            ...
            <div className="image-text-right">
              <h3>Advanced Technology at Your Service</h3>
              <p>
                Utilizing the latest AI-assisted imaging and biomarker analysis, our center ensures accuracy and early diagnosis to improve patient outcomes.
              </p>
              <p>
                Our experts work closely with you to personalize screening strategies tailored to your unique health profile.
              </p>
            </div>
          </div>
