          ...
          <div className="service-content">
            ...
            <div className="image-text-section" data-aos="fade-up">
              <div className="image-text-left">
                <img src={supportImg} alt="Cancer Awareness Support" />
              </div>
              <div className="image-text-right">
                <h3>Supporting You Every Step</h3>
                <p>
                  Our team provides comprehensive care and support throughout your screening journey to ensure comfort and confidence.
                </p>
                <p>
                  From initial consultation to follow-up, we stand by your side with expert guidance and compassionate care.
                </p>
              </div>
            </div>
